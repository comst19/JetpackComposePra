package com.comst.compositionlocal
...
import com.comst.compositionlocal.ui.theme.CompositionLocalTheme
...
fun Greeting() {
    ...
    CompositionLocalProvider(LocalElevation provides 12.dp) {
        Card(
            ...
            elevation = CardDefaults.cardElevation(defaultElevation = LocalElevation.current)
        ) {
