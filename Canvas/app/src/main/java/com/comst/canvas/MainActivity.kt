...
import com.comst.canvas.ui.theme.CanvasTheme
...
fun CanvasEx() {
    Canvas(modifier = Modifier.size(20.dp)){
        // 단계1 : drawLine을 사용, 파라미터로 색상, 시작('Offset')
        // 끝('Offset' 타입)을 받음
        drawLine(Color.Red, Offset(30f, 10f), Offset(50f, 40f))

        // 단계2 'drawCircle'을 사용하자. 색상, 반지름, 중앙('Offset')
